...
public class CheckBoxApp {
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblTusAficiones, GroupLayout.PREFERRED_SIZE, 129, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addComponent(chckbxAnime)
					.addGap(18)
					.addComponent(lblTusAficiones, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
	...
	public void actualizaAficiones() {
		String textoAficiones = lblSalida.getText();
		if (chckbxLectura.isSelected()) {
			textoAficiones = "Lectura ";
		} else if (chckbxSeries.isSelected()) {
			textoAficiones += "Series ";
		} else if (chckbxComic.isSelected()) {
			textoAficiones += "Comic ";
		} else if (chckbxAnime.isSelected()) {

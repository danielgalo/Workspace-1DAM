...
public class ParteListas {
  ...
  private JList<Integer> listListaGenerada;
  private JLabel lblMedia;
  private JList<Integer> listDebajoMedia;
  private JList<Integer> listEncimaMedia;
  ...
  private void initialize() {
    ...
    GroupLayout groupLayout =
        generateGroupLayout(lblNewLabel, lblValorMnimoDe, lblValorMximoDe, lblListaGenerada,
            scrollPane, scrollPane_1, scrollPane_2, lblListaDebajoMediia, lblListaEncimaMediia);

    // Listas
    listEncimaMedia = new JList<Integer>();
    scrollPane_2.setViewportView(listEncimaMedia);

    listDebajoMedia = new JList<Integer>();
    scrollPane_1.setViewportView(listDebajoMedia);

    listListaGenerada = new JList<Integer>();
    scrollPane.setViewportView(listListaGenerada);
    frame.getContentPane().setLayout(groupLayout);
  }

  /**
   * Generates group layout
   * 
   * @param lblNewLabel
   * @param lblValorMnimoDe
   * @param lblValorMximoDe
   * @param lblListaGenerada
   * @param scrollPane
   * @param scrollPane_1
   * @param scrollPane_2
   * @param lblListaDebajoMediia
   * @param lblListaEncimaMediia
   * @return
   */
  public GroupLayout generateGroupLayout(JLabel lblNewLabel, JLabel lblValorMnimoDe,
      JLabel lblValorMximoDe, JLabel lblListaGenerada, JScrollPane scrollPane,
      JScrollPane scrollPane_1, JScrollPane scrollPane_2, JLabel lblListaDebajoMediia,
      JLabel lblListaEncimaMediia) {
            ...
            .addGroup(groupLayout.createSequentialGroup().addContainerGap()
                .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                    ...
                    .addGroup(groupLayout.createSequentialGroup().addComponent(lblNewLabel)
                        .addPreferredGap(ComponentPlacement.UNRELATED).addComponent(txtCantidad,
                            GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.PREFERRED_SIZE))
                    .addGroup(groupLayout.createSequentialGroup()
                        .addComponent(lblValorMnimoDe, GroupLayout.PREFERRED_SIZE, 228,
                            GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.UNRELATED)
                        .addComponent(txtValMin, GroupLayout.PREFERRED_SIZE,
                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addGap(18).addComponent(btnGenerar))
                    .addGroup(groupLayout.createSequentialGroup()
                        .addComponent(lblValorMximoDe, GroupLayout.PREFERRED_SIZE, 228,
                            GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.UNRELATED).addComponent(txtValMax,
                            GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.PREFERRED_SIZE))
                    .addComponent(
                        lblListaGenerada, GroupLayout.PREFERRED_SIZE, 228,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblMedia, GroupLayout.DEFAULT_SIZE, 414, Short.MAX_VALUE)
                    .addGroup(groupLayout.createSequentialGroup()
                        .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
                            .addComponent(lblListaDebajoMediia, Alignment.LEADING,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(scrollPane_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
                                198, Short.MAX_VALUE))
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
                            .addComponent(lblListaEncimaMediia, GroupLayout.PREFERRED_SIZE, 198,
                                GroupLayout.PREFERRED_SIZE)
                            .addComponent(scrollPane_2, GroupLayout.DEFAULT_SIZE, 210,
                                Short.MAX_VALUE))))
                .addContainerGap()));
    groupLayout
        .setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(groupLayout.createSequentialGroup().addContainerGap()
                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblNewLabel).addComponent(txtCantidad, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(ComponentPlacement.UNRELATED)
                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblValorMnimoDe, GroupLayout.PREFERRED_SIZE, 16,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtValMin, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnGenerar))
                .addPreferredGap(ComponentPlacement.UNRELATED)
                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblValorMximoDe, GroupLayout.PREFERRED_SIZE, 16,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtValMax, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE))
                .addGap(18)
                .addComponent(lblListaGenerada, GroupLayout.PREFERRED_SIZE, 16,
                    GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 99,
                    GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(ComponentPlacement.UNRELATED)
                ...
                .addGap(18)
                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblListaDebajoMediia, GroupLayout.PREFERRED_SIZE, 16,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblListaEncimaMediia, GroupLayout.PREFERRED_SIZE, 16,
                        GroupLayout.PREFERRED_SIZE))
  ...
  /**
   * Genera lista con los valores de los campos de texto
   */
  private void generarLista() {
    ...
    if (!txtCantidad.getText().isBlank() && !txtValMin.getText().isBlank()
        && !txtValMax.getText().isBlank()) {
      btnGenerar.setEnabled(true);
    }
  ...
  /**
   * Genera lista por encima de la media
   * 
   * @param modelo
   * @param media
   */
  ...
  /**
   * Genera lista con valores por debajo de la media
   * 
   * @param modelo
   * @param media
   */
